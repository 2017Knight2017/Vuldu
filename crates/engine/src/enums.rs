...
impl From<u8> for SkillLevel {
	fn from(value: u8) -> Self {
		match value {
			...
			_ => panic!(
				"Incorrect skill level! Must be a number between 0 (I'm too young to die) to 4 (Nightmare!) inclusively."
			),
		}
	}
}
...
pub enum MobjFlagNum {
	...
	// The dumbest solution in this entire port,
	// but it is the only one working.
	VertOffset1,
	VertOffset2,
	VertOffset3,
	VertOffset4,
